...
void RegisterHandler::handle(const http::HttpRequest &req,
    ...
    if (userId != -1) {
        ...
        resp->setStatusLine(req.getVersion(), http::HttpResponse::k409Conflict,
                            "Conflict");
        resp->setCloseConnection(false);
        resp->setContentType("application/json");
...
int RegisterHandler::insertUser(const std::string &username,
