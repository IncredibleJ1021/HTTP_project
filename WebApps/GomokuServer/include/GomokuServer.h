...
class GomokuServer {
  ...
  private:
    ...
    void
    setSessionManager(std::unique_ptr<http::session::SessionManager> manager) {
    ...
    void restartChessGameVsAi(const http::HttpRequest &req,
    ...
    // 获取当前在线人数
    int getCurOnline() const { return onlineUsers_.size(); }
